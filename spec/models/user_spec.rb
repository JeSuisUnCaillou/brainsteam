...
describe User do
  ...
  it { should respond_to(:name) } # pareil que : it "should respond to 'name'" do  expect(@user).to respond_to(:name)  end
  ...
  describe "when name is not present" do
    before { @user.name = " " }
    it { should_not be_valid } # be_valid renvoie à @user.valid?
  end  
